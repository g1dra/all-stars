            ...
            <div class="match-preview">
                <section class="match-preview__body">
                    <header class="match-preview__header">
                        ...
                        <time class="match-preview__date" datetime="2017-05-17">17/11/2018</time>
                    </header>
                    ...
                    <div class="widget-game-result__main">
                        ...
                        <div class="widget-game-result__team widget-game-result__team--first">
                            <figure class="widget-game-result__team-logo">
                                <a href="#"><img
                                            src="assets/images/samples/logos/alchemists_last_game_results_small.png"
                                            alt=""></a>
                            </figure>
                        ...
                        <div class="widget-game-result__score-wrap">
                            <div class="widget-game-result__score">
                                <span class="widget-game-result__score-result widget-game-result__score-result--winner">107</span>
                                <span class="widget-game-result__score-dash">-</span> <span
                                        class="widget-game-result__score-result widget-game-result__score-result--loser">102</span>
                            </div>
                        ...
                        <div class="widget-game-result__team widget-game-result__team--second">
                            <figure class="widget-game-result__team-logo">
                                <a href="#"><img src="assets/images/samples/logos/sharks_last_game_results_small.png"
                                                 alt=""></a>
                            </figure>
                            <div class="widget-game-result__team-info">
